...
export const sharedAuthCopy: Record<AuthLanguage, SharedAuthText> = {
  ar: {
    ...
    errors: {
      ...
      emailNotFound: 'لا يوجد حساب مسجل بهذا البريد الإلكتروني. تأكد من البريد أو أنشئ حساب عيادة جديدًا.',
  ...
  en: {
    ...
    errors: {
      ...
      emailNotFound: 'No account is registered with this email. Double-check it or create a new clinic account.',
