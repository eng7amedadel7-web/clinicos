      ...
      <div className="border-b border-[#dbe5ea] bg-white/60 px-5 md:px-9 dark:border-[#1e3a4d] dark:bg-[#0b1824]/60">
        <div className="flex gap-1">
          <button
            ...
            className={`flex items-center gap-2 border-b-2 px-4 py-3.5 text-xs font-bold transition-colors ${activeTab === 'account' ? 'border-[#3c7e93] text-[#3c7e93] dark:border-[#8cc3dd] dark:text-[#8cc3dd]' : 'border-transparent text-[#8999a1] hover:text-[#3c7e93] dark:text-[#7e939e]'}`}
          ...
          <button
            ...
            className={`flex items-center gap-2 border-b-2 px-4 py-3.5 text-xs font-bold transition-colors ${activeTab === 'channels' ? 'border-[#3c7e93] text-[#3c7e93] dark:border-[#8cc3dd] dark:text-[#8cc3dd]' : 'border-transparent text-[#8999a1] hover:text-[#3c7e93] dark:text-[#7e939e]'}`}
            ...
            <section className="surface animate-rise delay-1 p-6 md:p-7">
              <div className="mb-6 flex items-center gap-3 border-b border-[#edf1f3] pb-5 dark:border-[#1e3a4d]">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-[#8999a1] dark:text-[#7e939e]">{en ? 'Sign-in and identity details' : 'بيانات تسجيل الدخول والهوية'}</p>
                </div>
              </div>
            ...
            <section className="surface animate-rise delay-2 p-6 md:p-7">
              <div className="mb-6 flex items-center gap-3 border-b border-[#edf1f3] pb-5 dark:border-[#1e3a4d]">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-[#8999a1] dark:text-[#7e939e]">{en ? 'This information is visible to your team' : 'تظهر هذه المعلومات لفريقك'}</p>
                </div>
              </div>
              <div className="grid gap-5 md:grid-cols-2">
