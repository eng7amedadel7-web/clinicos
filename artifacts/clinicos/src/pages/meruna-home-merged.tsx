...
import { ClinicDayDemo, HowItWorksSection, TrialBar } from './meruna-home-additions';
import {
  ArrowUpRight,
  BarChart3,
  Bell,
...
function App() {
  ...
  return (
    <div className={`landing-home ${theme === 'dark' ? 'is-dark' : ''} ${isArabic ? 'is-arabic' : ''} cf-page cf-grain cf-section min-h-[100dvh]`} dir="ltr">
      ...
      <TrialBar locale={lang} onStart={openDemo} />
      ...
      <main id="top">
        ...
        <ClinicDayDemo locale={lang} onExplore={openDemo} />
