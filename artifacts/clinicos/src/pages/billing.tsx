...
type BillingData = {
  subscription: null | { plan?: string; status: string; billing_interval?: string; trial_ends_at?: string | null; current_period_ends_at?: string | null; cancel_at_period_end?: boolean };
