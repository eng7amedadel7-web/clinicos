...
import { Building2, Check, Code, Plus, RefreshCw, ShieldCheck, UploadCloud, UsersRound, Zap } from "lucide-react";
...
type Tab = "branches" | "staff" | "roles" | "integrations";
...
export default function OrganizationSettings() {
  ...
  const tabs = useMemo(() => en
    ? [{ id: "branches" as const, label: "Branches", icon: Building2 }, { id: "staff" as const, label: "Staff", icon: UsersRound }, { id: "roles" as const, label: "Roles", icon: ShieldCheck }, { id: "integrations" as const, label: "Integrations & API", icon: Zap }]
    : [{ id: "branches" as const, label: "الفروع", icon: Building2 }, { id: "staff" as const, label: "الموظفون", icon: UsersRound }, { id: "roles" as const, label: "الأدوار", icon: ShieldCheck }, { id: "integrations" as const, label: "الربط مع الأنظمة والماركتنج", icon: Zap }], [en]);
