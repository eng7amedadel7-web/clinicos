...
export default function OrganizationSettings() {
  ...
  const tabs = useMemo(() => en
    ? [{ id: "branches" as const, label: "Branches", icon: Building2 }, { id: "staff" as const, label: "Staff", icon: UsersRound }, { id: "roles" as const, label: "Roles", icon: ShieldCheck }]
    : [{ id: "branches" as const, label: "الفروع", icon: Building2 }, { id: "staff" as const, label: "الموظفون", icon: UsersRound }, { id: "roles" as const, label: "الأدوار", icon: ShieldCheck }], [en]);
