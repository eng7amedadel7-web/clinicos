...
export function LiveInboxPage() {
  ...
  return <section className="mx-auto flex h-full min-h-0 w-full max-w-[1400px] flex-col" data-testid="page-inbox">
    ...
    <div className="mb-4 grid grid-cols-2 gap-2 sm:grid-cols-4 lg:grid-cols-5" role="tablist" aria-label="قنوات التواصل">
    ...
    <div className="surface grid h-[calc(100dvh-250px)] min-h-[520px] min-w-0 overflow-hidden p-0 lg:grid-cols-[350px_minmax(0,1fr)]" data-testid="inbox-workspace">
...
function OperationsDataState({ isLoading, isError, error, retry, children }: { isLoading: boolean; isError: boolean; error: unknown; retry: () => void; children: ReactNode }) {
