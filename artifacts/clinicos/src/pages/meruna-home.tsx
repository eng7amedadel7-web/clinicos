  ...
  return (
    <div className={`landing-home ${theme === 'dark' ? 'is-dark' : ''} ${isArabic ? 'is-arabic' : ''} cf-page cf-grain cf-section min-h-[100dvh]`} dir="ltr">
      ...
      <main id="top">
        ...
        {summaryQuery.data?.clinic && <div className="cf-container"><LiveWorkspacePulse lang={lang} clinicName={summaryQuery.data.clinic.name} stats={summaryQuery.data.stats} /></div>}
